...
YouMute.prototype.getVideoElement = function () {
  ...
  if (!this.videoEle) {
    this.videoEle = document.querySelectorAll(
...
YouMute.prototype.getRemainingTime = function () {
  var videoAdUiPreSkipText = document.getElementsByClassName(
  ...
  if (videoAdUiPreSkipText) {
    ...
    if (isNaN(number)) {
      let videoAdUiAttribution = document.getElementsByClassName(
...
YouMute.prototype.checkForAd = function (event) {
  let adButton = document.getElementsByClassName(
...
YouMute.prototype.adInProgress = function () {
  ...
  var skipButton = document.getElementsByClassName("ytp-skip-ad-button")[0];
